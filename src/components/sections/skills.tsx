                ...
                <div className="flex min-h-[8rem] flex-wrap gap-2 rounded-xl border border-neutral-100 bg-neutral-50 p-4 dark:border-white/[0.05] dark:bg-neutral-900/50">
                  {category.skills.map((skill) => (
                    <motion.div
                      ...
                      className="flex items-center gap-2 rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm transition-shadow hover:shadow-md dark:border-white/[0.1] dark:bg-neutral-800"
                    >
